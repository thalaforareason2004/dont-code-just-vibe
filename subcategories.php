<!-- filepath: /d:/New folder (3)/subcategories.php -->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Subcategories - Jayam Mobiles</title>
...
<body>
    ...
    <main>
        ...
        <div class="products-container">
            ...
            $stmt = $conn->prepare("SELECT id, subcategory_name, subcategory_image FROM accessories_subcategories WHERE category_id = ?");
            ...
            if ($subcategories_result->num_rows > 0) {
                while ($subcategory = $subcategories_result->fetch_assoc()) {
                    ...
                    echo '<a href="acessories.php?subcategory_id=' . $subcategory["id"] . '">';
                    echo '<img src="admin/uploads/' . htmlspecialchars($subcategory["subcategory_image"]) . '" alt="' . htmlspecialchars($subcategory["subcategory_name"]) . '">';
                    echo '<p>' . htmlspecialchars($subcategory["subcategory_name"]) . '</p>';
                    echo '</a>';
                    echo '</div>';
                }
            } else {
