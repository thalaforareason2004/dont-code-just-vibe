...
<head>
    ...
    <title>Brands - Jayam Mobiles</title>
    ...
    <style>
        ...
        * {
        ...
        /* Link styling inside brand items */
        .brand-item a {
        ...
        @media (max-width: 768px) {
            ...
            .brand-item {
                width: 48%; /* Adjust brand item size for tablets (2 per row) */
            }
        }
        ...
        @media (max-width: 480px) {
            ...
            .brand-item {
                width: 100%; /* Stack brand items on very small screens */
            }
        ...
        <div class="brands-container" id="brands-container">
            ...
            if ($brandResult->num_rows > 0) {
                while($brandRow = $brandResult->fetch_assoc()) {
                    $brandImagePath = 'admin/' . $brandRow["brand_logo"]; // Prepend 'admin/' to the path from the database
                    echo '<div class="brand-item">';
                    echo '<a href="mobiles.php?brand=' . $brandRow["brand"] . '">';
                    echo '<img src="' . $brandImagePath . '" alt="' . $brandRow["brand"] . '">';
                    echo '<p>' . $brandRow["brand"] . '</p>';
                    echo '</a>';
                    echo '</div>';
                }
            } else {
