...
<body>
    ...
    <div class="products-container">
        ...
        $stmt = $conn->prepare("SELECT id, name, image FROM accessories WHERE category_id = ?");
        ...
        if ($accessories_result->num_rows > 0) {
            while ($accessory = $accessories_result->fetch_assoc()) {
                ...
                echo '<a href="accessory_detail.php?accessory_id=' . $accessory["id"] . '">';
...
.search-results img {
    ...
    <footer style="width: 100%; background-color: #f1f1f1; text-align: center; padding: 10px 0; box-shadow: 0 -1px 5px rgba(0,0,0,0.1); margin-top: auto;">
